...
This repository is a minimal Angular sample showing integration of Dialog with the EJ2 [Angular Rich Text Editor](https://www.syncfusion.com/angular-components/angular-rich-text-editor).
...
- **Integration UG**: [Dialog Integration with Angular Rich Text Editor](https://ej2.syncfusion.com/angular/documentation/rich-text-editor/integrations/dialog)
